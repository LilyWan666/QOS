...
STATE_ACTIONS = {
    ...
    RUN_ONCE: ["verify_claim", "render_artifacts", "figure_visual_compare", "test_plan", "classify_failure", "terminal_failed"],
    RUN_FAILED: [
    ...
    VERIFY_CLAIM: ["success", "figure_visual_compare", "classify_failure", "terminal_failed"],
